    ...
    <div className="flex-1 bg-white border border-neutral-200 rounded-xl overflow-y-auto flex flex-col">
      ...
      <div className="border-t border-neutral-200 p-3">
        <button
          ...
          className="w-full py-2 rounded-lg bg-danger-100 text-danger-600 text-sm font-medium hover:bg-danger-200 transition-colors"
        >
          Limpiar carrito
        </button>
        {showClearConfirm && (
          <div className="mt-2 flex gap-2">
            <button
              ...
              className="flex-1 py-2 rounded-lg bg-danger-600 text-white text-sm font-medium hover:bg-danger-700"
            >
              Confirmar
            </button>
            <button
              onClick={() => setShowClearConfirm(false)}
              className="flex-1 py-2 rounded-lg bg-neutral-200 text-neutral-700 text-sm font-medium hover:bg-neutral-300"
            >
              Cancelar
            </button>
          </div>
